...
public unsafe static partial class Zig
{
  ...
  public static partial void BufferDrawText(IntPtr buffer, IntPtr text, UIntPtr textLen, UInt32 x, UInt32 y, IntPtr fg, IntPtr bg, byte attributes);
  ...
  public static partial void SetCursorPosition(IntPtr renderer, Int32 x, Int32 y, [MarshalAs(UnmanagedType.I1)] bool visible);

  [LibraryImport(LIB_NAME, EntryPoint = "setCursorStyle")]
  public static partial void SetCursorStyle(IntPtr renderer, IntPtr style, UIntPtr styleLen, [MarshalAs(UnmanagedType.I1)] bool blinking);
  ...
  public static partial UInt32 TextBufferGetCapacity(IntPtr textBuffer);
  ...
  [LibraryImport(LIB_NAME, EntryPoint = "textbufferGetSelectedText")]
  public static partial UInt64 TextBufferGetSelectedText(IntPtr buffer, IntPtr outPtr, UInt64 mexLen);

  [LibraryImport(LIB_NAME, EntryPoint = "textBufferGetPlainText")]
  public static partial UInt64 TextBufferGetPlainText(IntPtr buffer, IntPtr outPtr, UInt64 maxLen);

  [LibraryImport(LIB_NAME, EntryPoint = "textBuffferSetLocalSelection")]
  [return: MarshalAs(UnmanagedType.I1)]
  public static partial bool TextBufferSetLocalSelection(IntPtr buffer, Int32 anchorX, Int32 anchorY, Int32 focusX, Int32 focusY, IntPtr bgColor, IntPtr fgColor);

  [LibraryImport(LIB_NAME, EntryPoint = "textBufferInsertChunkGroup")]
  public static partial UInt32 TextBufferInsertChunkGroup(IntPtr buffer, UInt64 index, IntPtr textBytes, IntPtr fgPtr, IntPtr bgPtr, byte attributes);

  [LibraryImport(LIB_NAME, EntryPoint = "textBufferRemoveChunkGroup")]
  public static partial UInt32 TextBufferRemoveChunkGroup(IntPtr buffer, UInt64 index);

  [LibraryImport(LIB_NAME, EntryPoint = "textBufferReplacceChunkGroup")]
  public static partial UInt32 TextBufferReplaceChunkGroup(IntPtr buffer, UInt64 index, IntPtr textBytes, UInt32 textLen, IntPtr fgPtr, IntPtr bgPtr, byte attributes);

  [LibraryImport(LIB_NAME, EntryPoint = "textBufferGetChunkGroupCount")]
  public static partial UInt32 TextBufferGetChunkGroupCount(IntPtr buffer);

  [LibraryImport(LIB_NAME, EntryPoint = "getAreaAllocatedBytes")]
  public static partial UInt64 GetAreaAllocatedBytes(IntPtr buffer);
...
public interface IRenderLib
{
  ...
  public void UpdateStats(IntPtr renderer, double time, int fps, double frameCallbackTime);
  ...
  public void BufferDrawSuperSampleBuffer(IntPtr buffer, int x, int y, IntPtr pixelDataPtr, int pixelDataLenth, SuperSampleFormat format, int alignedBytesPerRow);
  ...
  public byte[]? TextBufferGetSelectedTextBytes(IntPtr buffer, int maxLength);
  public byte[]? GetPlainTextBytes(IntPtr buffer, int maxLength);
  public bool TextBufferSetLocalSelection(IntPtr buffer, int anchorX, int anchorY, int focusX, int focusY, Rgba? bgColor, Rgba? fgColor);
  public int TextBufferInsertChunkGroup(IntPtr buffer, int index, string text, Rgba? fg, Rgba? bg, byte? attributes);
  public int TextBufferRemoveChunkGroup(IntPtr buffer, int index);
  public int TextBufferReplaceChunkGroup(IntPtr buffer, int index, string text, Rgba? fg, Rgba? bg, byte? attributes);
  ...
  public long GetAreaAllocatedBytes(IntPtr buffer);
...
public class FFIRenderLib : IRenderLib
{
  ...
  public void BufferDrawText(IntPtr buffer, string text, int x, int y, Rgba color, Rgba? bgColor, byte? attributes = null)
  {
    ...
    Zig.BufferDrawText(buffer, textPtr, (UIntPtr)textLength, Convert.ToUInt32(x), Convert.ToUInt32(y), fgPtr, bgPtr, attributes ?? 0);
  }
  ...
  public void SetCursorStyle(IntPtr renderer, CursorStyle cursorStyle, bool blinking)
  {
    ...
    Zig.SetCursorStyle(renderer, stylePtr, (UIntPtr)stylePtr, blinking);
  }
  ...
  public TextBuffer TextBufferConcat(IntPtr buffer1, IntPtr buffer2)
  {
    ...
    int capacity = Convert.ToInt32(Zig.TextBufferGetCapacity(newBufferPtr));
  ...
  public void BufferDrawSuperSampleBuffer(IntPtr buffer, int x, int y, IntPtr pixelDataPtr, int pixelDataLenth, SuperSampleFormat format, int alignedBytesPerRow) =>
    Zig.BufferDrawSuperSampleBuffer(buffer, Convert.ToUInt32(x), Convert.ToUInt32(y), pixelDataPtr, Convert.ToUInt64(pixelDataLenth), (byte)format, Convert.ToUInt32(alignedBytesPerRow));
  ...
  public int TextBufferGetCapacity(IntPtr buffer) => (int)Zig.TextBufferGetCapacity(buffer);
  ...
  public byte[]? TextBufferGetSelectedTextBytes(IntPtr buffer, int maxLength)
  {
    IntPtr outPtr = Marshal.AllocHGlobal(Marshal.SizeOf<byte>() * maxLength);
    UInt64 selectedLen = Zig.TextBufferGetSelectedText(buffer, outPtr, (UInt64)maxLength);
    ...
    byte[] selectedBytes = new byte[(long)selectedLen];
    Marshal.Copy(outPtr, selectedBytes, 0, (int)selectedLen);
    Marshal.FreeHGlobal(outPtr);
  ...
  {
    IntPtr outPtr = Marshal.AllocHGlobal(Marshal.SizeOf<byte>() * maxLength);
    UInt64 selectedLen = Zig.TextBufferGetPlainText(buffer, outPtr, (UInt64)maxLength);
    if (selectedLen == 0)
    {
      Marshal.FreeHGlobal(outPtr);
      return null;
  ...
  public bool TextBufferSetLocalSelection(IntPtr buffer, int anchorX, int anchorY, int focusX, int focusY, Rgba? bgColor, Rgba? fgColor)
  {
    ...
    return Zig.TextBufferSetLocalSelection(buffer, anchorX, anchorY, focusX, focusY, bgColorPtr, fgColorPtr);
  }
  ...
  public int TextBufferInsertChunkGroup(IntPtr buffer, int index, string text, Rgba? fg, Rgba? bg, byte? attributes)
  {
    ...
    return (int)Zig.TextBufferInsertChunkGroup(buffer,
  ...
  public int TextBufferRemoveChunkGroup(IntPtr buffer, int index) =>
    (int)Zig.TextBufferRemoveChunkGroup(buffer, Convert.ToUInt32(index));
  ...
  public int TextBufferReplaceChunkGroup(IntPtr buffer, int index, string text, Rgba? fg, Rgba? bg, byte? attributes)
  {
    ...
    return (int)Zig.TextBufferReplaceChunkGroup(buffer,
                                                Convert.ToUInt32(index),
                                                Marshal.StringToHGlobalAnsi(text),
  ...
  public int TextBufferGetChunkGroupCount(IntPtr buffer) => (int)Zig.TextBufferGetChunkGroupCount(buffer);
  ...
  public LineInfo TextBufferGetLineInfo(IntPtr buffer)
  {
    ...
    this.TextBufferGetLineInfoDirect(buffer,
                                     Marshal.UnsafeAddrOfPinnedArrayElement(lineStarts, 0),
                                     Marshal.UnsafeAddrOfPinnedArrayElement(lineWidths, 0));
  ...
  public long GetAreaAllocatedBytes(IntPtr buffer) => (long)Zig.GetAreaAllocatedBytes(buffer);
